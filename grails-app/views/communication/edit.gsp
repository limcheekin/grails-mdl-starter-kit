...
<html>
    ...
    <body>
        <a href="#edit-communication" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-communication" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.communication}" method="PUT">
                <g:hiddenField name="version" value="${this.communication?.version}" />
                <fieldset class="form">
